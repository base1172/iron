...
val create : unit -> t
val is_empty : t -> bool
val find : t -> Session_id.t -> Catch_up_session.t option
val add : t -> Catch_up_session.t -> unit
...
val remove_link : t -> Session_id.t -> unit
...
val get_next_session : t -> [ `Catch_up_session of Catch_up_session.t | `Up_to_date ]
