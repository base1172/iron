...
module Push_event : sig
  ...
  val mark_as_used_by_metrics : t -> Metric_name.t -> [ `Already_marked | `Ok ]
end
...
val find : t -> Node_hash.First_12.t -> feature_id:Feature_id.t -> Push_event.t option
val deserializer : t Deserializer.t
val dump : t -> Iron_protocol.Push_events.What_to_dump.t -> Sexp.t
