module Stable = struct
  ...
  module Reaction = struct
    ...
    module V3 = struct
      ...
      let of_model m =
        let { V4.whole_feature_review_remaining; cr_summary } = V4.of_model m in
    ...
    module V2 = struct
      ...
      let of_model m =
        let { V3.whole_feature_review_remaining; cr_summary } = V3.of_model m in
        let whole_feature_review_remaining =
          List.map whole_feature_review_remaining ~f:(fun (user, line_count) ->
    ...
    module V1 = struct
      ...
      let of_model m =
        let { V2.whole_feature_review_remaining; cr_summary } = V2.of_model m in
        let whole_feature_review_remaining =
          List.map whole_feature_review_remaining ~f:(fun (user, line_count) ->
