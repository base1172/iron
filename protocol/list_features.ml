module Stable = struct
  ...
  module Action = struct
    ...
    module V1 = struct
      ...
      let to_model { feature_path; depth; use_archived } =
        let descendants_of =
          match feature_path with
          | None -> Which_ancestor.V1.Any_root
          | Some feature -> Feature feature
        in
        V2.to_model { descendants_of; depth; use_archived }
      ;;
    end
    ...
    module V1 = struct
      ...
      let to_v2 : t -> V2.t = function
        ...
        | `Was_archived_at archived_at ->
          Archived { archived_at; reason_for_archiving = "" }
      ;;
    end
  ...
  module Reaction = struct
    module V10 = struct
      ...
      type t = one list [@@deriving bin_io, sexp]
    ...
    module V9 = struct
      ...
      type t = one list [@@deriving bin_io]
    ...
    module V7 = struct
      ...
      let of_model m =
        List.map
          (V8.of_model m)
          ~f:(fun { feature_path; review_is_enabled; num_lines; next_steps; _ } ->
          { feature_path; review_is_enabled; num_lines; next_steps })
      ;;
    end
