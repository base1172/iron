  ...
  module Action = struct
    ...
    module V6 = struct
      ...
      let to_model { types; prefix } =
        V7.to_model { types = List.map types ~f:Type.V6.to_v7; prefix }
      ;;
    end
    ...
    module V5 = struct
      ...
      let to_model { types; prefix } =
        V6.to_model { types = List.map types ~f:Type.V5.to_v6; prefix }
      ;;
    end
    ...
    module V4 = struct
      ...
      let to_model { type_; prefix } =
        V5.to_model { types = [ Type.V4.to_v5 type_ ]; prefix }
      ;;
    end
