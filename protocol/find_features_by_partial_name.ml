  ...
  module Action = struct
    ...
    module V4 = struct
      ...
      let to_model { partial_name_prefix; namespace } =
        V5.to_model { V5.partial_name_prefix; namespace = Namespace.V3.to_v4 namespace }
      ;;
    end
    ...
    module V3 = struct
      ...
      let to_model { partial_name_prefix; namespace } =
        V4.to_model { V4.partial_name_prefix; namespace = Namespace.V2.to_v3 namespace }
      ;;
    end
    ...
    module V2 = struct
      ...
      let to_model { partial_name_prefix; namespace } =
        V3.to_model { V3.partial_name_prefix; namespace = Namespace.V1.to_v2 namespace }
      ;;
    end
  ...
  module Reaction = struct
    ...
    module V3 = struct
      ...
      let of_model m =
        ...
        { matching_features; rev_zero_roots = [] }
      ;;
    end

    module V2 = struct
      type t = Feature_path.V1.t list [@@deriving bin_io]
...
include
  Iron_versioned_rpc.Make
    (struct
      let name = "find-features-by-partial-name"
    end)
    (struct
      let version = 6
    end)
