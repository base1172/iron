module Stable = struct
  ...
  module Action = struct
    module V13 = struct
      type t =
        | Archived_features_cache of
            [ `Stats | `Ids_and_feature_paths | `Value of Feature_id.V1.t ]
        | Bookmarks_without_feature of
            Remote_repo_path.V1.t option * User_name.Or_all.V1.t
        | Build_info
        | Event_subscriptions
        | Feature of Feature_path.V1.t
        | Hash_consing_cache of
            [ `Stats | `Values | `Module_values of string | `Module_hash_data of string ]
  ...
  module Reaction = struct
    module V1 = struct
      type t = Sexp.V1.t [@@deriving bin_io, sexp_of]
