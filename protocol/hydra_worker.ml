module Stable = struct
  ...
  module Action = struct
    ...
    module V1 = struct
      ...
      let of_model { Model.feature_path; rev_zero; tip = _ } = { feature_path; rev_zero }
    end
  end
  ...
  module Reaction = struct
    ...
    module V1 = struct
      ...
      let of_model { Model.base; feature_id; need_diff4s_starting_from; aliases; _ } =
        { base; feature_id; need_diff4s_starting_from; aliases }
      ;;

      let to_model { base; feature_id; need_diff4s_starting_from; aliases } =
        { Model.base
        ; feature_id
...
include
  Register_old_rpc_converting_both_ways
    (struct
      let version = 1
    end)
    (Stable.Action.V1)
