  ...
  module By_id = struct
    module Action = struct
      ...
      module V1 = struct
        ...
        let to_model feature_id = V2.to_model { V2.feature_id; even_if_archived = false }
      end
  ...
  module Maybe_archived = struct
    module Action = struct
      ...
      module V2 = struct
        ...
        let to_model { what_feature; what_diff } =
          V3.to_model
            { V3.what_feature = Maybe_archived_feature_spec.V2.to_v3 what_feature
            ; what_diff
            }
        ;;
      end
      ...
      module V1 = struct
        ...
        let to_model { what_feature; what_diff } =
          V2.to_model
            { V2.what_feature = Maybe_archived_feature_spec.V1.to_v2 what_feature
            ; what_diff
            }
        ;;
      end
...
module Maybe_archived = struct
  include
    Iron_versioned_rpc.Make
      (struct
        let name = "get-feature-maybe-archived"
      end)
      (struct
        let version = 11
      end)
