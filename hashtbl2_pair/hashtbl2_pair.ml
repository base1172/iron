...
let find1_iter2 t key1 ~f = Hashtbl2.iter_key2 t.table1 key1 ~f
let find2_iter1 t key2 ~f = Hashtbl2.iter_key2 t.table2 key2 ~f
...
module Make (Key1 : Key) (Key2 : Key) = struct
  ...
  let create () = { table1 = Table1.create (); table2 = Table2.create () }
