...
module Column : sig
  ...
  (** include module type of Ascii_table.Column *)
  type 'row t
  ...
  val of_to_string : header:string -> ('a -> string) -> ('row, 'a) cell -> 'row t
  ...
  val int_or_error : header:string -> ('row, int Or_error.t) cell -> 'row t
