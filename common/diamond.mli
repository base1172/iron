...
[@@deriving compare, fields, sexp, hash]
...
val param : 'a Command.Flag.t -> doc:(string -> string) -> 'a t Command.Param.t
...
val is_forget : equal:('a -> 'a -> bool) -> 'a t -> bool

(** Detect the equivalence cases depending on the equality that hold between the 4 nodes
    of a revision graph *)
val classify : equal:('a -> 'a -> bool) -> 'a t -> Diff4_class.t

include Invariant.S1 with type 'a t := 'a t

module Stable : sig
  module V1 : sig
    type nonrec 'a t = 'a t [@@deriving hash]
