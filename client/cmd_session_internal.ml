...
let mark_id =
  Command.async'
    ...
    and even_if_some_files_are_already_reviewed =
...
let command =
  Command.group
    ~summary:"various review commands for Iron developers and tests"
    [ "mark-id", mark_id; "mark-file", mark_file; "show-num-lines", show_num_lines ]
;;
