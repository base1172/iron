  ...
  Command.async'
    ...
    ~readme:(fun () ->
      concat
        ...
        ; ").\n\n\
           When base or tip are provided, server will check if they match server's \
           knowledge\n\
           and only continue when they totally match.  If a 40-character hg revision is \
           provided\n\
    ...
    and base =
      flag
        "base"
        (optional rev_from_string_40_or_local_repo_arg_type)
