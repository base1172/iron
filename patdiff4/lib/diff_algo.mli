...
(** show the id only just for debugging purposes *)
...
val display_forget : context:int -> Slice.t Diamond.t -> View.t
val display_errors : Error.t list -> View.t option
...
val lines : t -> context:int -> Slice.t Diamond.t -> string list
