  ...
  (module struct
    let test_double_pdiff
      ...
      [%test_result: Slice.t Diamond.t list]
        (Segments.of_files
           ?verbose
           ~force_should_split_files_in_hunks_for_tests:true
           ~context
        ...
        |> List.map ~f:(fun (segment : Segment.t) ->
             ...
             List.iter Diff4_class.Shown_class.all ~f:(fun diff4_class ->
               List.iter
                 (Diff_algo.select_algos_for_review diff4_class)
                 ~f:(fun diff_algo ->
                 Diff_algo.apply
                   diff_algo
    ...
    let of_tagged_lines old_base new_base old_tip new_tip =
      ...
      { Diamond.b1 = f (old_base_start, old_base_lines, "old base")
    ...
    let%test_unit "single-line" =
      test_double_pdiff
        ...
        ~new_tip:(ints [ 0; 1; 2; 3; 4; 5 ])
        ~expect:[ of_tagged_lines (3, [ "0" ]) (3, [ "0" ]) (3, [ "0" ]) (3, [ "3" ]) ]
        ()
    ;;
    ...
    let%test_unit "multiple different" =
      test_double_pdiff
        ...
        ~expect:
          [ of_tagged_lines (1, [ "10" ]) (1, [ "20" ]) (1, [ "30" ]) (1, [ "40" ])
          ; of_tagged_lines (3, [ "11" ]) (3, [ "21" ]) (3, [ "31" ]) (3, [ "41" ])
          ; of_tagged_lines (5, [ "12" ]) (5, [ "22" ]) (5, [ "32" ]) (5, [ "42" ])
          ]
        ()
    ;;
    ...
    let%test_unit "different lengths" =
      test_double_pdiff
        ...
        ~new_tip:(ints [ 0; 1; 2 ])
        ~expect:
          [ of_tagged_lines (0, []) (0, [ "0" ]) (0, [ "0"; "1" ]) (0, [ "0"; "1"; "2" ])
          ]
        ()
    ;;
    ...
    let%test_unit "empty hunks" =
      test_double_pdiff
        ...
        ~expect:
          [ of_tagged_lines (0, [ "1" ]) (0, [ "2" ]) (0, [ "3" ]) (0, [ "4" ])
          ; of_tagged_lines (2, [ "1" ]) (2, []) (2, [ "1" ]) (2, [ "1" ])
          ; of_tagged_lines (9, []) (8, [ "2"; "3" ]) (9, [ "2"; "3" ]) (9, [ "3" ])
          ; of_tagged_lines (10, [ "1" ]) (11, [ "2" ]) (12, [ "3" ]) (11, [ "4" ])
          ]
        ()
    ;;
  end)
