module Stable = struct
  ...
  module Which_obligations = struct
    module V1 = struct
      type t =
        ...
        ; aliases_resolution : [ `None | `Using_latest_aliases_from_iron_server ]
        }
  ...
  module List_users = struct
    ...
    module Reaction = struct
      module V1 = struct
        type t = Unresolved_name.V1.Set.t [@@deriving bin_io, sexp_of]
  ...
  module List_groups = struct
    ...
    module Reaction = struct
      module V1 = struct
        type t = Unresolved_name.V1.Set.t Group_name.V1.Map.t [@@deriving bin_io, sexp_of]
...
module List_users = struct
  ...
  include
    Iron_command_rpc.Make
      (struct
        let name = "obligations-list-users"
      end)
      (struct
        let version = 1
      end)
...
module List_groups = struct
  ...
  include
    Iron_command_rpc.Make
      (struct
        let name = "obligations-list-groups"
      end)
      (struct
        let version = 1
      end)
